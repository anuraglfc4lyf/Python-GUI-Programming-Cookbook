...
labels_frame = ttk.LabelFrame(mighty, text=' Labels in a Frame ')
labels_frame.grid(column=1, row=7)        # now col 1
 
# Place labels into the container element
ttk.Label(labels_frame, text="Label1").grid(column=0, row=0, sticky=tk.W)
ttk.Label(labels_frame, text="Label2").grid(column=1, row=0, sticky=tk.W)
ttk.Label(labels_frame, text="Label3").grid(column=2, row=0, sticky=tk.W)
