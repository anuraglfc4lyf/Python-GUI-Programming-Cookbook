...
labels_frame = ttk.LabelFrame(win, text='')                 # no LabelFrame name
labels_frame.grid(column=0, row=7)
 
# Place labels into the container element 
ttk.Label(labels_frame, text="Label1").grid(column=0, row=0)
ttk.Label(labels_frame, text="Label2").grid(column=0, row=1)
ttk.Label(labels_frame, text="Label3").grid(column=0, row=2)
